...
- Поддерживает **реле** (выключатели, лампы, кнопки, сценарии), **розетки с энергомониторингом** (мощность, ток, напряжение), **кондиционеры**, **увлажнители воздуха**, **пылесосы**, **краны**, **лампы** (яркость, цвет, цветовая температура), **рулонные шторы / жалюзи**, **датчики температуры/влажности**, **датчики протечки** и **сценарные кнопки**
...
3. Датчик батареи подтягивается автоматически
4. Задайте имя, ID и комнату
5. Нажмите **«Готово»**
