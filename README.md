...
- Поддерживает **реле** (выключатели, лампы, кнопки, сценарии), **розетки с энергомониторингом** (мощность, ток, напряжение), **кондиционеры**, **увлажнители воздуха**, **чайники**, **пылесосы**, **краны**, **лампы** (яркость, цвет, цветовая температура), **рулонные шторы / жалюзи**, **датчики температуры/влажности**, **датчики протечки**, **датчики дыма** и **сценарные кнопки**
